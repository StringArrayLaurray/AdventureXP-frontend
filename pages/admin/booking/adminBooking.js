...
function renderContent(type, data) {
    ...
    switch (type) {
                ...
                <tbody>
                    ${data.map(booking => `
                        <tr>
                            ...
                            <td>${booking.time}</td>
                            <td>
                                <button class="delete-booking-button" data-id="${booking.id}">Delete</button>
                            </td>
                        </tr>`
            ).join("")}
                </tbody>
        ...
        case "create-form":
            ...
            //                 </select>
            //
            //                 <div id="activityCheckboxes" style="display: none;">
            //                     ${activityData.map(activity => `
            //                         <input type="checkbox" id="activity-${activity.id}" name="activityCheckbox" value="${activity.id}">
            //                         <label for="activity-${activity.id}">${activity.name}</label><br>
            //                     `).join("")}
            ...
            //
            //     // Add event listener to switch activity selection mode
            //     document.querySelectorAll("input[name='bookingType']").forEach(radio => {
            //         radio.addEventListener("change", () => {
            //             const isBusiness = document.getElementById("businessBooking").checked;
            //             document.getElementById("activitySelect").style.display = isBusiness ? "none" : "inline-block";
            //             document.getElementById("activityCheckboxes").style.display = isBusiness ? "inline-block" : "none";
            //         });
            //     });
            // });
            break;
